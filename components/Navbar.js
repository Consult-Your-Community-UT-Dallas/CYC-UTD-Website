            ...
            <nav className="bg-white border-b-2 border-gray-100 px-4 lg:px-6 py-2.5 fixed w-full z-10">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="/" className="flex items-center">
                        <img src="CYC_UTD_Logo.jpeg" className="mr-3 h-6 sm:h-9" alt="CYC UTD Logo" />
                        <span className="self-center text-xl font-semibold whitespace-nowrap lg:hover:text-primary-700">CYC UTD</span>
                    </a>
                    <div className="">
                        <button
                    ...
                    <div className={`${isMenuOpen ? "" : "hidden"} justify-between items-center w-full lg:flex lg:w-auto lg:order-1`} id="mobile-menu-2">
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <NavbarLink href="/#alumni">Contact</NavbarLink>
                        </ul>
                    </div>
                </div>
            </nav>
